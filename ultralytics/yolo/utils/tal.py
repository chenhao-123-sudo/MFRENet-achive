...
class TaskAlignedAssigner(nn.Module):
    ...
    def get_box_metrics(self, pd_scores, pd_bboxes, gt_labels, gt_bboxes, mask_gt):
        ...
        #YoloV8中在标签分配规则中也有用到bbox_iou的函数，对于这个我个人修改建议就是跟你计算IoU Loss的时候选择一样即可，
        # 但是这里不需要开启Focal选项，因为这里只是单纯求交并比。意思就是你在计算IoU Loss的时候，比如选择了Focal=True和CIoU=True，
        # 那么在这里你只需要选择CIoU=True即可。
